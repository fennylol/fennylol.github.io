...
import GenAIBadge from '../components/GenAIBadge.astro';
...
- <GenAIBadge level="none" link={false} /> Nothing in the project was generated. Design, code, art, and writing are all hand-made. Using an AI tool to look something up, the way I would use a search engine, does not change this label.
- <GenAIBadge level="minor" link={false} /> The project is hand-made, with generative AI used for isolated tasks: drafting small artifacts, solving sub-problems, or interacting with specific protocols, standards or APIs. The project page will name what tasks involve AI.
- <GenAIBadge level="major" link={false} /> Generative AI did a substantial share of the implementation. I directed the work, reviewed it, and am responsible for it, but I did not write significant portions.
