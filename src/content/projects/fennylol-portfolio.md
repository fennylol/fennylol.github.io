...
The same content-as-data approach applies to disclosure: every project's generative-AI involvement is a required field, not an afterthought. This project is marked "Major AI Use". Specifics are on the [AI policy](/ai).
