...
The same content-as-data approach applies to disclosure: every project's generative-AI involvement is a required field, not an afterthought. This project is marked "Used GenAI" — specifics are on the [AI page](/ai).
