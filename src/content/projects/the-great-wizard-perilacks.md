...
*Use your magic spells to move, place blocks, and interact through strange and esoteric perspectives.*
*In the end, only the grandest of towers will be enough!"*

>![The Great Wizard Perilacks Main Menu](/images/the_great_wizard_perilacks/splash.png "The Great Wizard Perilacks Main Menu")
> The Great Wizard Perilacks Main Menu
...
(*Please note that browsers cannot always handle physics simulations and you will occasionally clip into walls. Also the shader effects were too heavy to render in the browser. Downloading is recommended.*)

Made together with [Polytope Party](http://polytope.party/) for the 2026 BigMode game jam.
Built in one week using Godot 4.6, with assets made in Blender, Aseprite, and Procreate.
